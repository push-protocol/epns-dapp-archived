...
import {
  GAS_LIMIT,
  PUSH_BALANCE_TRESHOLD,
  ERROR_TOAST_DEFAULTS,
} from "../components/ViewDelegateeItem"
...
function GovernancePage({ epnsReadProvider, epnsWriteProvide }) {
  ...
  const [newDelegateeVotingPower, setNewDelegateeVotingPower] =
    React.useState(null)
  ...
  React.useEffect(() => {
    ...
    if (!!(library && account)) {
      ...
      const epnsTokenContract = new ethers.Contract(
        addresses.epnsToken,
        abis.epnsToken,
        signer
      )
  ...
  React.useEffect(() => {
    ...
    const allDelegateesPromise = delegateesList.map(
      async (oneDelegate: any) => {
        const { wallet } = oneDelegate
        const votingPower = await EPNSCoreHelper.getVotingPower(
          wallet,
          epnsToken
        )
    ...
    Promise.all(allDelegateesPromise).then(allDelegatees => {
      ...
      const delegateesAbove75k = allDelegatees.filter(
        ({ votingPower, votingPowerSimulate }) => {
  ...
  const getVotingPower = async address => {
    try {
      ...
      console.log(
        "🚀 ~ file: Delegate.tsx ~ line 86 ~ getVotingPower ~ err",
        err
      )
    }
  }
  ...
  const delegateAction = async newDelegatee => {
    ...
    if (tokenBalance < PUSH_BALANCE_TRESHOLD) {
      toast.dark(
        "Atleast " +
          PUSH_BALANCE_TRESHOLD +
          " PUSH required for gasless delegation!",
        {
          position: "bottom-right",
          type: toast.TYPE.ERROR,
          autoClose: 5000,
    ...
    <ThemeProvider theme={themes}>
      <Section>
                                ...
                                <Label>
                                  ...
                                  <div style={{ width: "5rem" }}>
                                    ...
                                    <InfoTooltip
                                      Infocolor={"gray"}
                                      title={
                                        "Delegate you PUSH votes by paying gas fee"
                                      }
                                    />{" "}
                                  </div>
                                </Label>
                      ...
                      >
                        ...
                        >
                          ...
                          {newDelegateeVotingPower && newDelegateeAddress && (
                            <StatsInnerTitle>
                              Voting Power: {newDelegateeVotingPower}
                            </StatsInnerTitle>
                          )}
                        </Item>
                      </Item>
        ...
        <Content padding="20px 20px 0px">
          <Item align="flex-start" margin="0px 15px 0px 15px">
            ...
            <H3 color={themes.color}>
              Let's start <B color={themes.color}>governing!!</B>{" "}
            </H3>
          </Item>
        ...
        <Content
          ...
          themes={darkMode ? themeLight : themeDark}
        >
          <Item
            align="stretch"
            justify="flex-start"
            ...
            <Item align="stretch" margin="0px 0px 0px 0px">
              <QnAItem>
                <Question
                  ...
                  hover="#e20880"
                >
                  <Span color={themes.color}>What are PUSH Delegatees?</Span>
                ...
                {showAnswers[0] && (
                  <Answer>
                    <Span>
                      ...
                      <b>75,000 $PUSH</b> delegated to them. They will be able
              ...
              <QnAItem>
                <Question
                  ...
                  hover="#e20880"
                >
                  <Span color={themes.color}>What are PUSH Nominees</Span>
                  <BsChevronExpand size={20} color={"#ddd"} />
                </Question>
                ...
                {showAnswers[1] && (
                  <Answer>
                    <Span>
                      Active community members who can be delegated $PUSH to
                      vote for proposals Snapshot. If you wish to be PUSH
                      Nominee, submit your nomination
                      <AMod href="https://gov.epns.io/t/epns-push-delegatee-nominations/21">
                        {" "}
                        here.{" "}
                      </AMod>
                      Once they get at least <b>75,000 $PUSH </b> delegated to
                      them, they become a PUSH Delegatee.
                    </Span>
                  </Answer>
                )}
              </QnAItem>
                ...
                {showAnswers[2] && (
                  <Answer>
                    ...
                    <UL>
                      ...
                      <LI>
                        <Span>
                          Submit your nomination by replying to the above post
                          in the PROPOSED TEMPLATE.
                        </Span>
                      </LI>
                    </UL>
                    <Span>
                      Now, once your nomination receives minimum of 10 likes, We
                      will be adding your wallet address on our Governance Front
                      end within 5-7 days. And later community members can start
                      delegating votes to you.
                    </Span>
                  </Answer>
                )}
              </QnAItem>
              ...
              <QnAItem>
                ...
                {showAnswers[3] && (
                  <Answer>
                    <Span>
                      No problem! You can show support to your favourite PUSH
                      Nominees by liking their nominations{" "}
                      <AMod href="https://gov.epns.io/t/epns-push-delegatee-nominations/21">
                        here
                      </AMod>
                      .
              ...
              <QnAItem>
                <Question
                  ...
                  hover="#e20880"
                >
                  <Span color={themes.color}>Where should I start?</Span>
                  <BsChevronExpand size={20} color={"#ddd"} />
                </Question>
                ...
                {showAnswers[4] && (
                  <Answer>
                    <Span>
                      ...
                      and introduce yoursef on the platform in the suggested
                      format.
                    </Span>
                  </Answer>
                )}
              ...
              <QnAItem>
                ...
                >
                  <Span color={themes.color}>
                    What happens to the delegated voting power when I sell my
                    PUSH tokens?
                  </Span>
                  <BsChevronExpand size={20} color={"#ddd"} />
                </Question>
                ...
                {showAnswers[5] && (
                  <Answer>
                    <Span>
                      If you delegate your voting power to someone/yourself and
                      later you sell your PUSH tokens, then the voting power of
                      those tokens gets revoked. Now the new owner gets to
              ...
              <QnAItem>
                <Question
                  ...
                  hover="#e20880"
                >
                  <Span color={themes.color}>How can I cast my vote?</Span>
                  <BsChevronExpand size={20} color={"#ddd"} />
                </Question>
