      ...
      developer: {
        ...
        drilldown: {
          ...
          dynamicEnviroment: {
            src: "svg/network.svg",
            iconFactory: null,
            name: window.location.hostname == "app.epns.io" ? "Staging dApp" : window.hostname == "staging-app.epns.io" ? "Dev dApp": "Prod dApp",
            title: window.location.hostname == "app.epns.io" ? "Staging dApp" : window.hostname == "staging-app.epns.io" ? "Dev dApp": "Prod dApp",
            alt: window.location.hostname == "app.epns.io" ? "Checkout Staging dApp" : window.hostname == "staging-app.epns.io" ? "Checkout Dev dApp": "Checkout Prod dApp",
            href: window.location.hostname == "app.epns.io" ? "https://staging-app.epns.io" : window.hostname == "staging-app.epns.io" ? "https://app-dev.epns.io": "https://app.epns.io",
            newTab: false,
            isRoute: false,
            hasMenuLogic: false,
            headerTag: {
