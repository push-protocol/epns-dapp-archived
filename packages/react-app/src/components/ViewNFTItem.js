      ...
      <ChannelLogo
        theme={
          !!account && !!library && account === NFTObject.owner
            ...
            : !!account &&
              !!library &&
              NFTObject.owner !== 0xfba7df351add4e79099f63e33b2679edfdd5e2ab
            ? "#eee"
            : "#fff"
        }
      >
        <ChannelLogoOuter>
          <ChannelLogoInner>
            ...
            {!!account &&
              !!library &&
              NFTObject.owner !==
                0xfba7df351add4e79099f63e33b2679edfdd5e2ab && (
                <NFTStatus>
              ...
              {!!account &&
                ...
                !loading && (
                  <UnsubscribeButton disabled={!NFTObject.claimable}>
                    ...
                    {!NFTObject.claimable && (
                      <ActionTitle hideit={txInProgress}>
                        Rewards Claimed
                      </ActionTitle>
                    )}
                  </UnsubscribeButton>
