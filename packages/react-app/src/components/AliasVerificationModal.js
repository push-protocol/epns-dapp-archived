...
export default function AliasVerificationModal({
  ...
  const submitAlias = () => {
    ...
    const anotherSendTxPromise =
      polygonCommsContract.verifyChannelAlias(mainAdress);
      ...
      <AliasModal ref={modalRef}>
        <Item align="flex-start">
          ...
          {verificationStatus === null ? (
            <H3>
              There has been an error in the verification of your alias, Please
              contact the admin
            </H3>
          ) : (
            <H3>
              Before you can use this channel on this chain, you first need to
              verify your Alias.
            </H3>
          )}
        </Item>
